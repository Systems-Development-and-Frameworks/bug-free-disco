<template>
    <form @submit.prevent="checkForm">
        ...
        <input v-model="news.title" placeholder="Title">
        <input v-model="news.body" placeholder="Body">
    ...
    methods: {
        checkForm(e) {
            ...
            if (this.newsInNewsList(this.news.title)) {
                this.errors.push('A news with title (' + this.news.title + ') is already contained in the list of news');
            }
